...
class MedicalToJson:
    def __init__(self):
        ...
        self.data_path = os.path.join(cur_dir, "data/medical4.json")
    ...
    def read_nodes(self):
        ...
        return set(drugs), set(foods), set(checks), set(departments), set(producers), set(symptomss), set(diseases), set(
            cures), disease_infos, \
    ...
    def create_nodes_json(self):
        Drugs, Foods, Checks, Departments, Producers, symptomss, Diseases,Cures,disease_infos,rels_check, \
        ...
        entities.extend(l)
        l=self.write_node_json('symptoms', symptomss)
        entities.extend(l)
    ...
    def create_rels_json(self):
        ...
        rels_drug_producer, rels_recommanddrug,rels_symptoms, rels_acompany, rels_category, rels_cureway = self.read_nodes()
        relations=[]
        ...
        relations.append(rel_set)
        rel_set=self.write_rel_json('Disease', 'symptoms', rels_symptoms, 'has_symptoms', '症状')
        relations.append(rel_set)
